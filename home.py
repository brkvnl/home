...
def tick():
	...
	if time2 != time1:
		...
		if GPIO.input(12) == 1:
                        # Isitma kapaliysa
                        if "(int(time.strftime('%H')) == 0 or int(time.strftime('%H')) == 12)" (int(time.strftime('%H')) % 2 == 0) and GPIO.input(32) == 1:
                                GPIO.output(32, GPIO.LOW)
                                print 'VANA AC'
                                # Vanayi ac

                        if "(int(time.strftime('%H')) == 0 or int(time.strftime('%H')) == 12) == 0" (int(time.strftime('%H')) % 2 == 1) and GPIO.input(32) == 0:
